...
**See for yourself**: check out the [live demo](https://da_doomer.gitlab.io/markdown-slides/) (and the source file [`presentation.md`](https://sumeet72.github.io/markdown-slides/example/presentation)).
